...
public class OEns<T extends Comparable<? super T>> extends LinkedList<T> implements Comparable<OEns<T>> {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(" Restes de b1 et b2 " + b1.restes(b2)); // ([3], [4])
        ...
        System.out.println(" Restes de c1 et c2 " + c1.restes(c2)); // ([], [5])
        ...
        System.out.println(" Restes de d1 et d2 " + d1.restes(d2)); // ([3, 7], [4, 6])
